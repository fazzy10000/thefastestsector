...
const docRes = await fetch(`https://docs.googleapis.com/v1/documents/${DOC_ID}?fields=body(content(endIndex))`, {
...
console.log(JSON.stringify({ endIndex }))
